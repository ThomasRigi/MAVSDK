...
template_path_plugin_operators_h="${script_dir}/../templates/plugin_operators_h"
template_path_plugin_operators_cpp="${script_dir}/../templates/plugin_operators_cpp"
...
for plugin in action telemetry; do
    ...
    ${protoc_binary} -I ${proto_dir} --custom_out=${tmp_output_dir} --plugin=protoc-gen-custom=${protoc_gen_dcsdk} --custom_opt="file_ext=h,template_path=${template_path_plugin_operators_h}" ${proto_dir}/${plugin}/${plugin}.proto
    mv ${tmp_output_dir}/${plugin}/${plugin^}.h ${script_dir}/../src/plugins/${plugin}/include/plugins/${plugin}/${plugin}_operators.h

    ${protoc_binary} -I ${proto_dir} --custom_out=${tmp_output_dir} --plugin=protoc-gen-custom=${protoc_gen_dcsdk} --custom_opt="file_ext=cpp,template_path=${template_path_plugin_operators_cpp}" ${proto_dir}/${plugin}/${plugin}.proto
    mv ${tmp_output_dir}/${plugin}/${plugin^}.cpp ${script_dir}/../src/plugins/${plugin}/${plugin}_operators.cpp
