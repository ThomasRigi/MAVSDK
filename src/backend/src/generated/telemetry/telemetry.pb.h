...
enum TelemetryResult_Result : int {
  TelemetryResult_Result_UNKNOWN = 0,
  TelemetryResult_Result_SUCCESS = 1,
  TelemetryResult_Result_NO_SYSTEM = 2,
  TelemetryResult_Result_CONNECTION_ERROR = 3,
  TelemetryResult_Result_BUSY = 4,
  TelemetryResult_Result_COMMAND_DENIED = 5,
  TelemetryResult_Result_TIMEOUT = 6,
...
constexpr TelemetryResult_Result TelemetryResult_Result_Result_MIN = TelemetryResult_Result_UNKNOWN;
constexpr TelemetryResult_Result TelemetryResult_Result_Result_MAX = TelemetryResult_Result_TIMEOUT;
...
class TelemetryResult :
 ...
 public:
  ...
  static constexpr Result UNKNOWN =
    TelemetryResult_Result_UNKNOWN;
  static constexpr Result SUCCESS =
    TelemetryResult_Result_SUCCESS;
  static constexpr Result NO_SYSTEM =
    TelemetryResult_Result_NO_SYSTEM;
  static constexpr Result CONNECTION_ERROR =
    TelemetryResult_Result_CONNECTION_ERROR;
  static constexpr Result BUSY =
    TelemetryResult_Result_BUSY;
  static constexpr Result COMMAND_DENIED =
    TelemetryResult_Result_COMMAND_DENIED;
  static constexpr Result TIMEOUT =
    TelemetryResult_Result_TIMEOUT;
